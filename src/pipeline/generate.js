...
const SYSTEM_PROMPT = `You are an expert at writing Agent Skills documentation for smart contracts. You produce SKILL.md files following the Agent Skills specification.
